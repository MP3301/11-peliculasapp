...
export class Convert {
  public static toMovieDetails(json: string): MovieDetails {
    return cast(JSON.parse(json), r('MovieDetails'));
  }

  public static movieDetailsToJson(value: MovieDetails): string {
    return JSON.stringify(uncast(value, r('MovieDetails')), null, 2);
  }
}
  ...
  MovieDetails: o(
    [
      ...
      { json: 'poster_path', js: 'poster_path', typ: '' },
      {
        ...
        js: 'production_companies',
        typ: a(r('ProductionCompany')),
      },
      {
        json: 'production_countries',
        js: 'production_countries',
        typ: a(r('ProductionCountry')),
      },
