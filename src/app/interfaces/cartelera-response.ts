...
export class Convert {
  public static toCarteleraResponse(json: string): CarteleraResponse {
    return cast(JSON.parse(json), r('CarteleraResponse'));
  }

  public static carteleraResponseToJson(value: CarteleraResponse): string {
    return JSON.stringify(uncast(value, r('CarteleraResponse')), null, 2);
  }
}
  ...
  Result: o(
    [
      ...
      { json: 'id', js: 'id', typ: 0 },
      {
        ...
        js: 'original_language',
        typ: r('OriginalLanguage'),
      },
